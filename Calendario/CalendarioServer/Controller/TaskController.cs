...
namespace CalendarioAPI.Controller
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        public IActionResult Post([FromHeader] string token, TaskCreation task)
        {
            ...
            SQLDatabase.NoReturnQuery($"INSERT INTO Tasks(AccountID, PriorityID, Name, Description, IconID, IsCompleted) VALUES({loginToken.ID}, {task.PriorityID}, \"{task.Name}\", \"{task.Description}\", \"Calendar\", 0)");
